...
import static com.anmi.anime.utils.ByteUtil.char2ToInt2;
import static com.anmi.anime.utils.ByteUtil.int2ToChar2;
...
public class AFISTime {
	...
	public void fromBinary(byte[] data, int offset) {
		...
		this.milliSecond = char2ToInt2(data, offset + 4);
	}
	...
	public byte[] toBinary(byte[] data, int offset) {
		...
		int2ToChar2(this.milliSecond, data, offset + 4);
		return data;
	}
