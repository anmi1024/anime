...
import static com.anmi.anime.struct.FPTStruct.getEncoding;
...
public class CommonStruct {
    ...
    public static <T> int getFieldLength(Field field, T t) throws Throwable{
        ...
        if (field.isAnnotationPresent(Length.class)) {
            ...
            try {
                fieldLength = (refMethod.invoke(t)==null || refMethod.invoke(t).toString().isEmpty()) ? 0 : Integer.valueOf(refMethod.invoke(t).toString());
